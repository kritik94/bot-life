...
* [`src/clj/bot_life/`](src/clj/bot_life/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/cljs/bot_life/`](src/cljs/bot_life/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bot_life/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `bot-life` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/bot_life/config.cljs) defaults to `true` in
...
```clj
(ns bot-life.example
  (:require [bot-life.config :as config])
...
```sh
port=2000 java -jar target/bot-life.jar
```
